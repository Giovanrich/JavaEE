        ...
        <div class="container"><!--Start main container-->
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    <form action="ContactController?action=add" method="POST" role="form">
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <div class="form-group">
                                    ...
                                    <td>
                                    <input type="text" class="form-control" name="surname" placeholder="Surname" ></td>
                                </div>
                                </tr>
                                <tr>
                                <div class="form-group">
                                    ...
                                    <td>
                                    <input type="email" class="form-control" name="email" placeholder="Email" ></td>
                                </div>
                                </tr>
                                <tr>
                                <div class="form-group">
                                    ...
                                    <td>
                                    <input type="phone" class="form-control" name="phone" placeholder="Phone" ></td>
                                </div>
                                </tr>
